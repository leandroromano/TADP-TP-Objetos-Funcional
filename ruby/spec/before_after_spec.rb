...
describe "before_and_after_each_call" do
  ...
  context "Con herencia" do
    ...
    it "Una clase que herede de otra deberia poder usar los metodos redefinidos por el before_and_after de la superclase" do
      expect(@un_objeto.m).to be 1
      expect(@un_objeto.el_bloque_before_se_llamo).to be true
      expect(@un_objeto.el_bloque_after_se_llamo).to be true
    end
    ...
    it "Una clase que herede de orta que use before_and_after deberia poder llamar a otro before_and_after" do
      class Ejemplo5 < SuperClassEjemplo
          before_and_after_each_call( Proc.new{self.counter += 1}, Proc.new{})
